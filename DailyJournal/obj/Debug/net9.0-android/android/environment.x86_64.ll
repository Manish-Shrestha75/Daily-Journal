...
@dso_cache = dso_local local_unnamed_addr global [52 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.11_name, ; name: libQuestPdfSkia.so
		ptr null; void* handle
	}, ; 7
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.12_name, ; name: libqpdf.so
		ptr null; void* handle
	}, ; 13
	%struct.DSOCacheEntry {
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [29 x i8] c"com.companyname.dailyjournal\00", align 16
...
@.DSOCacheEntry.11_name = private unnamed_addr constant [19 x i8] c"libQuestPdfSkia.so\00", align 16
@.DSOCacheEntry.12_name = private unnamed_addr constant [11 x i8] c"libqpdf.so\00", align 1
